        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Categories_ParantId",
                        column: x => x.ParantId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    DiscountDiscountTitle = table.Column<string>(name: "Discount_DiscountTitle", type: "nvarchar(50)", maxLength: 50, nullable: true),
                    DiscountDiscountAmount = table.Column<int>(name: "Discount_DiscountAmount", type: "int", nullable: true),
                    ShippingMethodShippingType = table.Column<string>(name: "ShippingMethod_ShippingType", type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ShippingMethodShippingCost = table.Column<int>(name: "ShippingMethod_ShippingCost", type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Shir = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    City = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PostalCode = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    PostalAddress = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
